...
- Collected & preprocessed wholesale trading market data.
- Engineered ML features; built input/output matrices.
- Trained RNN, Random Forest, LSTM, and Time-GPT models.
- Tuned hyperparameters for enhanced prediction.
- Built Power BI dashboards for visual analytics.
